[![R-CMD-check](https://github.com/S-E-SCROGGINS/INXVALID/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/S-E-SCROGGINS/INXVALID/actions)
...
**INXVALID** is an R package for validating composite indices. It provides a structured workflow for assessing redundancy, dimensionality, theoretical structure, and contribution balance among variables.
...
- **Confirmatory factor analysis** for theoretical validation (`cfa_var`)
...
2. **Dimensionality Assessment**  
   Determine the number of latent components required to explain variance.

3. **Theoretical Validation**  
   Confirm whether variables load according to expected conceptual groupings.
